        ...
        <Layout apiData={response} >
            ...
            <section className="py-8 lg:py-8 relative lg:animate-to-top">
                <div className="max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-7xl xl:max-w-7xl 2xl:max-w-7xl mx-auto px-8 relative">
                    {/* <SectionHeader animate={false} classList="w-full font-medium" headingLevel='h1' heading={bannerData.title} />
                    <p className="mb-12 text-gray-700">{bannerData.highlight}</p>
                    ...
                    {/* <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-x-4 pt-20"> */}
