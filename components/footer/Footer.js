...
export default function Footer({settingsWrap,clientsData}) {
    ...
    return (
        <>
            ...
            <footer className="overflow-x-hidden pb-8 text-gray text-xs relative">
            ...
            <div className="w-full lg:flex sm:flex-row items-center pb-10 border-b-2 border-gray-900 border-opacity-10">
                    ...
                    <div className="opacity-80 flex flex-row">
                         <div className="w-1/2 text-center lg:text-left flex items-end">
                           {/* <Link href="/">
                                <div className="text-green-900">
                                    <Image
                                        src="/logo-color.png" // Path to your image
                            ...
                            <span className="w-full font-neuehaas hidden lg:inline"><span href="/">{siteSetting.siteName}</span> &copy; {new Date().getFullYear()}. All Rights Reserved</span>
                        </div>
                    </div>
